...
const body = () => {
    const selectedProjects = projects.map(proj => <Link key={proj.title} link={proj.link} target="_blank">{proj.title}</Link>);
			...
			<Grid>
				...
				<GridItem>
					<p className="italic text-right">
						"I won’t rest until there’s a pixel-perfect solution on
						the screen"
					</p>
				</GridItem>
			</Grid>
